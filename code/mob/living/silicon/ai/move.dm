...
/proc/getCameraMove(var/atom/old, var/direct, var/skip_disabled = 0)
	...
	var/list/old_types = slipttext("[A.type]", "/")
	...
	for(var/obj/machinery/camera/current in machines)
		...
		//for instance, /area/A and /area/B would have shared_types = 2 (because of how slipttext works)
		...
		var/list/new_types = slipttext("[cur_area.type]", "/")
